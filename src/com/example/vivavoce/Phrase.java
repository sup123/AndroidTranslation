...
public class Phrase {
	...
	*/
	...
	public void doAudio(){
		...
		try {
			if(this.postTranslateLanguage == Language.CHINESE_SIMPLIFIED){
				urlOfAudioTranslation = Speak.execute(postTranslate, 
						SpokenDialect.CHINESE_SIMPLIFIED_PEOPLES_REPUBLIC_OF_CHINA);
			} else if( this.postTranslateLanguage == Language.JAPANESE){
				urlOfAudioTranslation = Speak.execute(postTranslate, 
						SpokenDialect.JAPANESE_JAPAN);
			} else {
	...
	public void doTranslationAndAudio(){
		...
		if(this.postTranslateLanguage == Language.CHINESE_SIMPLIFIED 
				|| this.postTranslateLanguage == Language.JAPANESE ){
